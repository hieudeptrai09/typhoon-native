...
// Today as a "YYYY-MM-DD" string, matching how storm dates travel. A storm with no end date is
// still active, so today stands in for the missing end rather than dropping it from a calculation.
